	...
	<div class="main-panel" id="full">
		...
		<nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
			<div class="container-fluid">
				<div class="navbar-wrapper">
					...
					<a class="navbar-brand" id="topMain" href="/Home/MorseMain.do">Better Morse</a>
				</div>
			</div>
		</nav>
		...
		<div class="content" id="full2"><br>
			...
			<div class="mt-4 text-monospace" style="text-align: center; color: #5ABB92;">
				...
				<p id="yourSpeed" class="mb-2">Your Speed Level is</p><p id="speedLevel" style="2color: #ccc5b9">Begginer</p>
			</div>
...
<script>
	...
	window.onload = function() {
		...
		htmlFlash.innerText = questionWords[roundIndex];
	}

	let speedCnt = 0;
	// 속도를 변경함
	function clickSpeedMessage() {
		speedCnt++;
		if (speedCnt > 6) {
			speedCnt = 0;
		}
		switch (speedCnt) {
			case 1:
				document.getElementById('speedLevel').innerText = "Bronze";
				document.getElementById('speedLevel').style.color = "#B27C4A"; break;
			case 2:
				document.getElementById('speedLevel').style.color = "#B3B2BE";
				document.getElementById('speedLevel').innerText = "Silver"; break;
			case 3:
				document.getElementById('speedLevel').style.color = "#CDA63D";
				document.getElementById('speedLevel').innerText = "Gold"; break;
			case 4:
				document.getElementById('speedLevel').style.color = "#83EAAB";
				document.getElementById('speedLevel').innerText = "Platinum"; break;
			case 5:
				document.getElementById('speedLevel').style.color = "#30A8DD";
				document.getElementById('speedLevel').innerText = "Challenger"; break;
			case 6:
				themeHardCore();
				document.getElementById('speedLevel').style.color = "#9D1D04";
				document.getElementById('speedLevel').innerText = "HARDCORE"; break;
			default:
				themeBasic();
				document.getElementById('speedLevel').innerText = "Begginer"; break;
		}
	}
	...
	function soundMorseCode(morseCode) {
		...
		let dot = 1.2 / 15;
		let adjustInterval = 7;

		switch (speedCnt) {
			case 1: dot = 1.2 / 17; break;
			case 2: dot = 1.2 / 18; adjustInterval = 6.8; break;
			case 3: dot = 1.2 / 19; adjustInterval = 6.7; break;
			case 4: dot = 1.2 / 20; adjustInterval = 6.5; break;
			case 5: dot = 1.2 / 21; adjustInterval = 6; break;
			case 6: dot = 1.2 / 22; adjustInterval = 5; break;
			default: dot = 1.2 / 15; adjustInterval = 4; break;
		}
		// 2. "-.", "-...", "-.-."
	...
	function ClickSoundBtn() {
		soundMorseCode(toMorse(questionWords[roundIndex]));
	...
	function ClickNextBtn() {
		...
		let tempQuestion = questionWords[roundIndex].split('');
		...
		// 처음부터 시작하기 위해 인덱스를 초기화

		if (roundIndex > questionWords.length - 1) {
	...
	function resultLocation() {
		location.href = "/Test/Listen/ResultPage.do?data=" + resultArr.length + "";
	}

	function themeBasic() {
		document.getElementById('flashBody').style.backgroundColor = "white";
		htmlFlash.style.color = "white";
		document.getElementById('sound').style.backgroundColor = "#5ABB92";
		document.getElementById('sound').style.color = "white";
		document.getElementById('next').style.backgroundColor = "#5ABB92";
		...
		document.getElementById('flash').style.color = "#5ABB92";
		document.getElementById('questionIs').style.color = "#5ABB92";
		document.getElementById('yourAnswerIs').style.color = "#5ABB92";
		document.getElementById('speedLevel').style.color = "#ccc5b9";
		document.getElementById('yourSpeed').style.color = "#5ABB92";
		document.getElementById('moreFast').style.color = "#5ABB92";
		htmlFlash.style.backgroundColor = "#5ABB92";
		htmlFlash.style.color = "white";

		document.getElementById('full').style.backgroundColor = "";
		document.getElementById('full1').style.backgroundColor = "";
		document.getElementById('full2').style.backgroundColor = "";

		document.getElementById('round').style.color = "black";
		document.getElementById('sideBarFull').style.backgroundColor = "";
		// document.getElementById('sideBarLogo').style.backgroundColor = "";

		document.getElementById('topMain').innerText = "Better Morse";
		document.getElementById('topMain').style.color = "#67625C";
	}
	function themeHardCore() {
		document.getElementById('flashBody').style.backgroundColor = "black";
		htmlFlash.style.color = "black";
		document.getElementById('sound').style.backgroundColor = "black";
		document.getElementById('sound').style.color = "#9D1D04";
		document.getElementById('next').style.backgroundColor = "black";
		document.getElementById('next').style.color = "#9D1D04";

		document.getElementById('userInput').style.backgroundColor = "black";
		document.getElementById('userInput').style.color = "#9D1D04";

		document.getElementById('questionIs').style.color = "#9D1D04";
		document.getElementById('yourAnswerIs').style.color = "#9D1D04";
		document.getElementById('yourSpeed').style.color = "#9D1D04";
		document.getElementById('moreFast').style.color = "#9D1D04";
		htmlFlash.style.backgroundColor = "#9D1D04";
		// document.getElementById('full').style.backgroundColor = "#9D1D04";
		// document.getElementById('full1').style.backgroundColor = "#2F0202";
		// document.getElementById('full2').style.backgroundColor = "#2F0202";

		document.getElementById('round').style.color = "#9D1D04";
		// document.getElementById('sideBarFull').style.backgroundColor = "#2F0202";
		// document.getElementById('sideBarLogo').style.backgroundColor = "#2F0202";

		document.getElementById('topMain').innerText = "HARD CORE";
		// document.getElementById('topMain').style.color = "#9D1D04";
	}
</script>
</body>
</html>
