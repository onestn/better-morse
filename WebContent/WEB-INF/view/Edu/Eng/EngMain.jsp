...
<body>
	<div class="wrapper">
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						...
						<a class="navbar-brand" href="/Home/MorseMain.do">Better Morse</a>
					</div>
				</div>
			</nav>
			<!-- End Navbar -->
		...
		<div class="content"><br>
			<h1 class="ml-4 mt-4 mb-4 text-monospace text-center"> -&nbsp;English&nbsp;- </h1><br><br>
			<div class="card">
				<div class="card-body">
					<div class="card" style="height: 150px; background-color: #F4F3EF;">
						<h2 class="m-5 text-monospace" style="text-align: center;">
							<a href="/Edu/Eng/EngWord.do" style="color: #73B895;">Word</a>
						</h2>
					</div>
					<div class="card" style="height: 150px; background-color: #F4F3EF;">
						<h2 class="m-5 text-monospace" style="text-align: center;">
							<a href="/Edu/Eng/EngCh.do" style="color: #73B895;">Character</a></h2>
					</div>

					<div class="card" style="height: 150px; background-color: #F4F3EF;">
						<h2 class="m-5 text-monospace" style="text-align: center;">
							<a href="/Edu/Eng/EngWorst.do" style="color: #73B895;">Worst Character</a>
						</h2>
					</div>
				</div>
			</div>
