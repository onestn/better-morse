...
<body>
	<div class="wrapper">
		...
		<div class="main-panel">
			...
			<h2 class="ml-4 mt-4 mb-4 text-monospace text-center"> Number Character </h2><br>
	...
	// 시작됨과 동시에 선언
	htmlWord.innerText = number[indexCnt];
	htmlCode.innerHTML = "<br>";
	htmlCode.innerText += getKeyByValue(code, number[indexCnt]);
