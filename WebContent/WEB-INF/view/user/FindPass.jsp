...
<div class="limiter">
    <div class="container-login100" style="background-color: #f4f3ef">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 shadowbox">
            <span class="login100-form-title p-b-49">Find Your Password</span>

            <div class="container">
                <div class="signup-content">
                    <form name="f" action="/user/getFindPass.do" method="post"
                          onsubmit="return radioCheck(this);">

                        <div class="form-group wrap-input100 validate-input" data-validate="Error">
                            <span class="label-input100">ID</span>
                            <input class="input100" type="text" name="user_id" id="user_id" placeholder="Type your ID" />
