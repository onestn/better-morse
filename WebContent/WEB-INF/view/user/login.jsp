...
<div class="login">
	<h1>Login</h1>
    <form name="f" action="/user/LoginResult.do" onsubmit="return doLogin(this);" method="post">
        ...
        <button type="submit" name="signup" onclick="location.href='/user/signup.do'" class="btn btn-primary btn-block btn-large">Sign Up</button>
        <button type="submit" name="signup" onclick="location.href=''" class="btn btn-primary btn-block btn-large">Find ID</button>
        <button type="submit" name="signup" onclick="location.href='/user/getFindPass.do'" class="btn btn-primary btn-block btn-large">Find PW</button>
    </form>
</div>
